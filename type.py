...
df2.to_csv('framework.csv', index=False)
df3.to_csv('sql.csv', index=False)
df4.to_csv('app.csv', index=False)
df5.to_csv('os.csv', index=False)
df15.to_csv('editor.csv', index=False)
